...
tests.print_pre_post_comparison_tables(know_fc_data, know_fm_data, know_gen_data, sorted_keys)
wl('#### Between conditions')
tests.print_condition_comparison_tables(know_fc_data, know_fm_data, sorted_keys, sorted_subkeys)
wl('![Item scores](know_gain_diff.png "Item scores")')
wl('![Person scores](know_gain_abil.png "Person scores")')
wl('')
wl('### Comprehension questions')
wl('#### Between pre- and posttest')
tests.print_pre_post_comparison_tables(comp_fc_data, comp_fm_data, comp_gen_data, sorted_keys)
wl('#### Between conditions')
tests.print_condition_comparison_tables(comp_fc_data, comp_fm_data, sorted_keys, sorted_subkeys)
