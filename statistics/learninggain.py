...
wl()
wl("Pretest             : " + print_descriptions([l[0] for l in fc_flashcard_lg.values()]))
wl("Posttest            : " + print_descriptions([l[1] for l in fc_flashcard_lg.values()]))
...
wl()
wl("Pretest             : " + print_descriptions([l[0] for l in fm_flashcard_lg.values()]))
wl("Posttest            : " + print_descriptions([l[1] for l in fm_flashcard_lg.values()]))
...
wl()
wl("Pretest             : " + print_descriptions([l[0] for l in {**fc_flashcard_lg, **fm_flashcard_lg}.values()]))
wl("Posttest            : " + print_descriptions([l[1] for l in {**fc_flashcard_lg, **fm_flashcard_lg}.values()]))
...
wl("=== Learning gains ===")
wl()
wl("Flashcard condition : " + print_descriptions([l[1] - l[0] for l in fc_flashcard_lg.values()]))
wl("Flashmap condition  : " + print_descriptions([l[1] - l[0] for l in fm_flashcard_lg.values()]))
wl("Total learning gain : " + print_descriptions([l[1] - l[0] for l in fc_flashcard_lg.values()] + [l[1] - l[0] for l in fm_flashcard_lg.values()]))
wl()
wl("Normality tests:")
...
wl("=== Flashcard condition ===")
wl()
wl("Pretest             : " + print_descriptions([l[0] for l in fc_item_lg.values()]))
wl("Posttest            : " + print_descriptions([l[1] for l in fc_item_lg.values()]))
wl("Mann-Whitney-U test : " + print_mann_whitney_u_test([l[0] for l in fc_item_lg.values()], [l[1] for l in fc_item_lg.values()]))
wl()
wl("=== Flashmap condition ===")
wl()
wl("Pretest             : " + print_descriptions([l[0] for l in fm_item_lg.values()]))
wl("Posttest            : " + print_descriptions([l[1] for l in fm_item_lg.values()]))
...
wl("=== General pre- and posttests ===")
wl()
wl("Pretest             : " + print_descriptions([l[0] for l in {**fc_item_lg, **fm_item_lg}.values()]))
wl("Posttest            : " + print_descriptions([l[1] for l in {**fc_item_lg, **fm_item_lg}.values()]))
...
wl("=== Learning gains ===")
wl()
wl("Flashcard condition : " + print_descriptions([l[1] - l[0] for l in fc_item_lg.values()]))
wl("Flashmap condition  : " + print_descriptions([l[1] - l[0] for l in fm_item_lg.values()]))
wl("Total learning gain : " + print_descriptions([l[1] - l[0] for l in fc_item_lg.values()] + [l[1] - l[0] for l in fm_item_lg.values()]))
wl()
wl("Normality tests:")
